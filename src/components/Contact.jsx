...
const Contact = () => {
  ...
  const [phonetransition, setphonetransition] = useState(false);
  const [textareatransition, settextareatransition] = useState(false);
  return (
    <div className="w-full flex  mx-auto my-0 bg-gradient-to-r to-[#5B31B2] from-[#B766CD] p-10 h-auto">
      <div className="w-5/6 flex-col md:flex-row h-auto mx-auto my-0 flex">
        <div className="w-1/2 object-cover relative">
          <Image
            className="w-full  h-full top-0 z-0 rounded-md object-fill"
            quality={100}
            unoptimized
            src={BG2}
            width={100}
            ...
            alt="Picture"
          />
          {/* <div className="z-20 w-full absolute bottom-0 text-white p-3">
            <div className="text-5xl font-bold text-center p-3">ChatCamp</div>
            <div className="text-sm text-justify text-slate-200 p-3">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
              enim ad minim veniam, quis nostrud exercitation ullamco laboris
              nisi ut aliquip ex ea commodo consequat.
            </div>
            <div className="w-full justify-center gap-4 flex p-3">
              <div className="p-2 bg-slate-500 rounded-sm cursor-pointer">
                <svg
        ...
        <div className="w-1/2 p-12 flex flex-col gap-3">
          <div>
          ...
          <form className="w-full flex-col gap-4 flex">
            <div className="flex w-full items-center gap-2">
              <input
                onFocus={() => {
                  90;
                  setfirstNametransition(!firstNametransition);
                }}
                onBlur={() => {
                  setfirstNametransition(!firstNametransition);
                }}
              ...
              <input
                onFocus={() => {
                  setlastNametransition(!lastNametransition);
                }}
                onBlur={() => {
                  setlastNametransition(!lastNametransition);
                }}
            ...
            <div>
              <input
                onFocus={() => {
                  setemailtransition(!emailtransition);
                }}
                onBlur={() => {
                  setemailtransition(!emailtransition);
                }}
            ...
            <div>
              ...
              <input
                type={"number"}
                onFocus={() => {
                  setphonetransition(!phonetransition);
                }}
                onBlur={() => {
                  setphonetransition(!phonetransition);
                }}
